...
%		\item Nur pseudo OS erledigt aufgaben wie hardware abstraction, low-level device control
%		\item Auch Laufzeitumgebung
%		\end{itemize}
...
%		\begin{itemize}
%		\item Arbeitet auf Peer-2-Peer Basis
%		\item hat zentralen Knoten, roscore, steuert alles
%		\item Prozesskommunikation per message-system
%		\item messages werden über topics ausgetauscht ähnelt vom Prinzip her einem event-bus
%		\item Ein ROS System kann sich über mehrere Rechner ausdehnen
%		\end{itemize}
